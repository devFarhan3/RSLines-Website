...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // copy of produtc farhan
        function productSlider_copy() {
            $('.productSlider_copy').slick({
                dots: false,
                infinite: true,
                slidesToShow: 4,
                slidesToScroll: 1,
        ...
        function productSlider_tab_wala() {
            $('.productSlider_tab2').slick({
                dots: false,
                infinite: true,
                slidesToShow: 4,
                slidesToScroll: 1,
